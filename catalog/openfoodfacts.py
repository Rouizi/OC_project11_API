...
class OpenFoodFacts:
    ...
    def get_category(self):
        """This function retrives 10 categories from the web site"""
    ...
    def get_product(self):
        """This function retrives 50 products from each categories"""
        ...
        for i in range(10):
            ...
            for page in range(1, 2):
                ...
                # #     # 'product_name', 'nutrition_grade_fr' or 'code' in their fields so we make an if to filter all that
    ...
    def get_substitute(self):
        """This function retrives a substitute for a given product"""
